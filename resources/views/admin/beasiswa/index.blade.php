        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item">/</li>
                    <li class="breadcrumb-item">List Beasiswa</li>
  ...
  <div class="col-12">
    ...
    <div class="row">
        ...
        <div class="col-6 d-flex justify-content-end">
            <a href="{{ route('beasiswa-create') }}" class="btn btn-md btn-info">
          ...
          <tbody>
              @foreach ($beasiswa as $item)
                    <tr>
                      ...
                      <th>
                            <img src="{{ asset('img/beasiswa/'.($item->gambar ?? 'user.png')) }}" width="110px"
                            class="image img" />
                      </th>
                      <th>{{ $item->title }}</th>
                      ...
                      <th>
                         <div class="btn-group">
                          <a href="{{ route('beasiswa-edit', $item->id) }}" class="btn btn-warning text-white">
                            <i class="far fa-edit"></i>
                            Edit
                          </a>
                          <a href="{{ route('beasiswa-destroy', $item->id) }}" class="btn btn-danger f-12">
