...
@section('title', 'UCIC | Tambah Data Berita')
@section('style')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">/</li>
                        <li class="breadcrumb-item">Add Berita</li>
                    </ol>
                </div>
        ...
        <div class="col-md-6">
            <div class="card card-primary">
                <div class="card-header text-center" style="border-radius:10px 10px 0px 0px; background-color: #1C3F94;">
                    <h3 class="card-title text-white">Add Data Berita</h3>
                </div>
                ...
                <form action="{{ route('berita-store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-footer" style="border-radius:0px 0px 10px 10px; background-color: #1C3F94;">
                        ...
                        <a href="{{ route('berita-list') }}" class="btn btn-secondary btn-footer">Back</a>
                    </div>
                </form>
            </div>
        </div>
