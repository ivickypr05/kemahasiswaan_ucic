...
@section('title', 'UCIC | List Data PPK Ormawa')
@section('style')
@endsection
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">/</li>
                        <li class="breadcrumb-item">List PPK</li>
                ...
                <div class="card-header" style="border-radius:10px 10px 0px 0px; background-color: #1C3F94;">
                    <div class="row">
                        ...
                        <div class="col-6 d-flex justify-content-end">
                            <a href="{{ route('pkk-create') }}" class="btn btn-md btn-info">
                        ...
                        <tbody>
                            @foreach ($pkk as $item)
                                <tr>
                                    ...
                                    <th>
                                        <div class="btn-group">
                                            <a href="{{ route('pkk-edit', $item->id) }}" class="btn btn-warning text-white">
                                                <i class="far fa-edit"></i>
                                                Edit
                                            </a>
                                            <a href="{{ route('pkk-destroy', $item->id) }}" class="btn btn-danger f-12">
