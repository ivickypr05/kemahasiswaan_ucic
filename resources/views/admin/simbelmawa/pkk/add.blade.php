        ...
        <div class="col-md-6">
            <div class="card card-primary">
                <div class="card-header text-center" style="border-radius:10px 10px 0px 0px; background-color: #1C3F94;">
                    <h3 class="card-title text-white">Add Data PKK</h3>
                </div>
                ...
                <form action="{{ route('pkk-store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <p class="text-primary">Format gambar harus : jpg/jpeg/png/gif </p>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="file" class="form-control @error('pedoman') is-invalid @enderror" id="pedoman"
                                name="pedoman" value="{{ old('pedoman') }}" placeholder="enter">
