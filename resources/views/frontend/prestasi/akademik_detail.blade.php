    ...
    <section id="blog" class="blog">
        <div class="container" data-aos="fade-up">
            <div class="breadcrumbs">
                <a href="{{ route('prestasi-akademik') }}">Prestasi Akademik</a>
                <span class="separator"><i class="bi bi-chevron-double-right"></i></span>
                <a href="{{ route('detail-prestasi-akademik', $preakademik->id) }}">Detail Prestasi Akademik
                    "{{ $preakademik->title }}"</a>
            </div>
            <div class="row">
                <div class="col-lg-8 entries">
                    <article class="entry entry-single">
                        <h2 class="entry-title">Akademik - {{ $preakademik->title }}
                        </h2>
                ...
                <div class="col-lg-4">
                    <div class="recommended">
                        <h3 class="d-flex justify-content-center recommended-title mb-3"><b>Prestasi Akademik
                                Lainnya</b>
                        </h3>
                        <hr>
                        <ul class="recommended-list">
                            @foreach ($rekakademik->take(5) as $recommended)
                                <li class="recommended-list-item">
                                    <b><a href="{{ route('detail-prestasi-akademik', $recommended->id) }}">
                                            {{ $recommended->title }}
                                        </a></b>
                                </li>
                            @endforeach
