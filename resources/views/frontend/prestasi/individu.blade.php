        ...
        <section id="about" class="about mb-5">
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-lg-6">
                        <img style="width:100%"
                            src=" {{ asset('img/ukm/' . ($item->gambar ?? 'https://c4.wallpaperflare.com/wallpaper/94/602/369/surface-light-silver-background-wallpaper-preview.jpg')) }} "
                            alt="">
                    </div>
            ...
            <div class="container">
                <div class="row content">
                    <div class="col-lg-12">
                        ...
                        <br></br>
                        <br></br>
                        <h4 class="text-center">Belum ada informasi Prestasi Akademik.</h4>
                    </div>
                </div>
            </div>
        </section><!-- End About Section -->
