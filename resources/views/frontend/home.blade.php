...
<section id="pricing" class="pricing">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <center><h5><b>Daftar Prestasi</b></h5></center>
                    <br><br>
                </div>
                ...
                @foreach ($preindividu->take(1) as $item)
                    <div class="col-lg-4 col-md-6">
                        <div class="box">
                            ...
                            <div class="square-image">
                                <img class="small-square-img" src="{{ asset('storage/' . ($item->gambar_1 ?? 'https://c4.wallpaperflare.com/wallpaper/94/602/369/surface-light-silver-background-wallpaper-preview.jpg')) }}" alt="">
                            </div>
    ...
    <section id="pricing" class="pricing">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <center><h5><b>Daftar Organisasi Kemahasiswaan</b></h5></center>
                    <br><br>
                </div>
    ...
    <section id="pricing" class="pricing">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <center><h5><b>Daftar Kegiatan SIMBELMAWA</b></h5></center>
                    <br><br>
                </div>
